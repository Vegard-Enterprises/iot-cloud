      ...
      links: [
        {
          ...
          link: '/docs/getting-started-guides/helloworld/'
        },
        {
          icon: 'title',
          name: 'Tenant profiles',
          link: '/docs/user-guide/tenant-profiles/'
        },
        {
          icon: 'insert_chart',
          name: 'API',
        ...
        },
        {
          ...
          link: '/docs/user-guide/ui/widget-library/'
        }
      ]
    }],
    [Authority.TENANT_ADMIN, {
      links: [
        ...
        },
        {
          ...
          name: 'Rule engine',
          link: '/docs/user-guide/rule-engine-2-0/re-getting-started/'
        },
        {
          icon: 'insert_chart',
          name: 'API',
        ...
        },
        {
          ...
          link: '/docs/user-guide/device-profiles/'
        }
      ]
    }],
