...
* Parse code as a device claiming info (in this case ```{deviceName: string, secretKey: string}```)<br>and then claim device (see [Claiming devices](${siteBaseUrl}/docs${docPlatformPrefix}/user-guide/claiming-devices/) for details):
